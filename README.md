...
## Sprint 5 – UI localization & Kubernetes
  ...
  Language switching: Available in two places:
...
## Sprint 7 – Quality assurance
  ...
  •	Key findings: missing save confirmations (H1: 2.5), no delete confirmation dialog (H5: 2.5), inconsistent button labels (H4: 1.0)
  ...
  •	SonarQube via Jenkins — Quality Gate: Passed
  •	Security: 0 open issues (A), Reliability: 0 open issues (A), Maintainability: 6 open issues (A)
  Security testing
  •	Method: Manual OWASP Top 10 fundamentals — April 2026
  •	JWT validation: Pass | SQL Injection: Pass | Password hashing (BCrypt): Pass
  •	XSS escaping: needs frontend verification (Medium)
...
## Authors
Course: Software Production Project (AD) — Spring 2026
Group: Group 8
Name	                              Role
